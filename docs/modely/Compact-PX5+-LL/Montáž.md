# Montáž – Compact PX5+ LL

## Hlavní komponenty
  {% include "../../modules/Hlavní-komponenty-PX5+/Hlavní-komponenty-PX5+.md" %}
...
## Schéma vedení kabelů 
  {% include "../../modules/Kabeláž-P5-PX5/Kabeláž-P5-PX5.md" %}

## Zamezení pohybu kabelů v rámu
  {% include "../../modules/Štětka/Štětka.md" %}

## Displej
  {% include "../../modules/Displej/Displej.md" %}

## Ovladač
  {% include "../../modules/Ovladač-PX5/Ovladač-PX5.md" %}
